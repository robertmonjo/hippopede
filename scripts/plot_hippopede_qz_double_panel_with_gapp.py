...
def main():
    ...
    monjo = MonjoProjectedHyperconical(alpha=0.283, k=1.0)
    ...
    png_path = OUTDIR / "hippopede_qz_centered_t0_3p0_double_panel_with_gapp.png"
    pdf_path = OUTDIR / "hippopede_qz_centered_t0_3p0_double_panel_with_gapp.pdf"
