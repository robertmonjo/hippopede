...
class MonjoProjectedHyperconical:
    def __init__(self, alpha=0.5, k=1.0):
        self.alpha = alpha
        self.k = k
...
def main():
    ...
    monjo = MonjoProjectedHyperconical(alpha=0.5, k=1.0)
    ...
    png_path = OUTDIR / "hippopede_qz_centered_t0_3p0_double_panel_with_gapp_alpha05.png"
    pdf_path = OUTDIR / "hippopede_qz_centered_t0_3p0_double_panel_with_gapp_alpha05.pdf"
