...
\begin{tabular}{lll}
\hline
$z$ / Range & Observable / $H(z)$ [km\,s$^{-1}$\,Mpc$^{-1}$] & Source \\
\hline
\multicolumn{3}{l}{\textit{Kinematic summaries}} \\
local--intermediate & $q_0$,\;$z_t$ & Cosmographic \cite{myrzakulov2025q0,gao2024frb,hu2025transition} \\
low--intermediate & $q(z)$,\;$E(z)$ & CC+Pantheon$+$ GaPP \cite{seikel2012gapp} \\
\hline
