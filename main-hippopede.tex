...
\begin{tabular}{lll}
\hline
Redshift ($z$) & Observable / $H(z)$ [km\,s$^{-1}$\,Mpc$^{-1}$] & Source \\
\hline
...
\hline
\multicolumn{3}{l}{\textit{Cosmic chronometers}} \\
