...
The non-uniform early behaviour leads to oblique sectors having finite initial radius $|\sin\chi|$ with $\dot a_\chi(0)=0$, while the axial direction collapses to zero, which confirms the biaxial character of the model.
