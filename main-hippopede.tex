...
\end{equation}
In the numerical implementation, the projection parameter is fixed to $\alpha=0.283$ ($0.325 \pm 0.005$) according to \cite{monjo2018projected}. The projected reference Hubble function is then defined, following \cite{monjo2018projected}, by
\begin{equation}
\blue{
