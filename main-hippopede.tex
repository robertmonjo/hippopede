...
\end{equation}
Since $x_\max = ...$ from the metric domain ..., the value of the projecting angle is$\gamma_0$ is  \blue{The corresponding projected hyperconical proper distance is therefore}
\begin{equation}
\blue{
