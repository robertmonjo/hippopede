...
The Python scripts used to generate all figures and supplementary diagnostics, together with the required data files (CC/BAO compilation, Pantheon$+$ input, and GaPP code), are included in the project folder. Script names match the figure labels in the captions.
