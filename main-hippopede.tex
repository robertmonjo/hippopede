...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figurehippopede_qz_centered_t0_3p0_double_panel_with_gapp}
\caption{
...
0.649,\ 0.728,\ 0.904,\ 1.184,\ 1.434
}
\end{equation}
\blue{at $T=0.07,\ 0.10,\ 0.20,\ 0.50,\ 1.0\,\mathrm{MeV}$, respectively. In other words, the same projected family admits a smooth perceived thermal history for which the whole BBN window is brought to within a factor of order unity of the standard radiation background, rather than remaining separated by four orders of magnitude as in the low-redshift constant-$\alpha$ branch or by a factor $\sim10$ as in the pure $\alpha=1/2$ branch.}
