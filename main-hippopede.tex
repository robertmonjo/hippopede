...
\end{equation}
with the derivatives evaluated numerically along each centered history. \textcolor{red}{\sout{In the final comparison figures we fix $t_0=3$ ¡as a normalisation choice defining the present slice of the numerical comparison and yielding a convenient redshift window for the plotted histories, and show the angular sectors $\chi=0^\circ,15^\circ,30^\circ,45^\circ,60^\circ,85^\circ$. The case $\chi=0^\circ$ is then identical to the unprojected hyperconical/coasting reference of the same centered prescription.}}\textcolor{blue}{The comparison figures use $t_0=3$ as the present normalisation and display sectors $\chi=0^\circ,15^\circ,30^\circ,45^\circ,60^\circ,85^\circ$; the axial case $\chi=0^\circ$ coincides with the hyperconical/coasting reference.}
