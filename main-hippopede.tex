...
\end{equation}
Since $x_\max = \dots$ from the metric domain $\dots$, the value of the projecting angle is $\gamma_0 = \pi/3$ [please complete]. The corresponding projected hyperconical proper distance is therefore
\begin{equation}
\blue{
