...
\end{equation}
with the derivatives evaluated numerically along each centered history. In the final comparison figures we fix $t_0=3$ \textcolor{blue}{as a normalisation choice defining the present slice of the numerical comparison and to obt} and show the angular sectors $\chi=0^\circ,15^\circ,30^\circ,45^\circ,60^\circ,85^\circ$. The case $\chi=0^\circ$ is then identical to the unprojected hyperconical/coasting reference of the same centered prescription.
