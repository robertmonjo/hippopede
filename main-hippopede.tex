...
This confirms the effective observational isotropization discussed in \S\ref{sec:discussion}: the running-$\alpha$ BBN result above is an effective perceived thermal history of the projected radiation sector, not a sector-by-sector nucleosynthesis calculation on the full anisotropic background.}}
