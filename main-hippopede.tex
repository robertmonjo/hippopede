...
\begin{figure}[t]
\centering
\includegraphics[width=0.78\textwidth]{figures/hippopede_growth_3d.png}
...
\end{equation}
\bIn the numerical implementation, the projection parameter is fixed to $\alpha=0.283$ ($0.325 \pm 0.005$) according to \cite{monjo2018projected}. The projected reference Hubble function is then defined, following \cite{monjo2018projected}, by
\begin{equation}
\blue{
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/hippopede_qz_centered_t0_3p0_double_panel_with_gapp.pdf}
\caption{
