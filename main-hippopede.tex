...
\begin{tabular}{lll}
\hline
Redshift $(z)$  & Observable(s) & Dataset \\
\hline
...
\hline
Redshift $(z)$ & $H(z)$ [km s$^{-1}$ Mpc$^{-1}$] &  Cosmic chronometers \\
\hline
...
%$0.07$--$1.26$ & $H(z)$, hence $E(z)=H/H_0$ & Cosmic chronometers \\ \label{tab:cc_data_figures}
